...
void draw_objects()
{
	...
	/*if(modificadorPra=2)
		...
		{
			case 0:
				m.pintarPuntos(1.0,0,0,2);
				break;
			case 1:
				m.pintarAristas(1.0,0,0,1.2);
				break;
			case 2:
				m.pintarSolido(1,0,0,0);	
				break;
			case 3:
				m.pintarAjedrez(1,0,0,0,1,0);
				break;
...
int main(int argc, char **argv)
{
	...
	if(argc < 2)
	{
		cerr << "Tienes que introducir un archivo PLY: ./practica2 <ruta archivo ply> <modo> (construcion estatica 'e' o revolucion 'r')" << endl;
		return -1;
	}
	...
	r.cargarModelo(argv[1]);
	r.generarModelo(30,r.vertices);
